...
from pipeline.silver.clean_violations import run as clean_viol
from pipeline.silver.match_establishments import run as match_est

with DAG(
    dag_id="build_silver_layer",
    description="Clean bronze into silver + fuzzy-match establishments per city",
    schedule=None,
    ...
    t_viol = PythonOperator(task_id="clean_violations", python_callable=clean_viol)
    ...
    [t_mb, t_insp, t_viol] >> t_match >> trigger_gold
